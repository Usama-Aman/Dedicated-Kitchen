package com.codingpixel.dedicatekitchen.customwidgets
    ...
    fun setImage(url: String?) {
        ...
        if ((url ?: "").isNotEmpty()) {
            Glide.with(context).load(url)
                ...
                .error(R.drawable.gray_rounded_rectangle).into(this)

        } else {
            Glide.with(context).load(R.drawable.img_dk_placeholder)
                .placeholder(R.drawable.img_dk_placeholder)
                .error(R.drawable.gray_rounded_rectangle).into(this)
        }
    }

    fun setCategoryImage(url: String?) {
        ...
        if ((url ?: "").isNotEmpty()) {
            ...
            Glide.with(context).load(R.drawable.gray_rounded_rectangle)
                .placeholder(R.drawable.img_dk_placeholder)
                .error(R.drawable.gray_rounded_rectangle).into(this)
        }
    }
...
//            com.codingpixel.connectfight.helpers.ImageLoader.loadImageViewWithPlaceHolder(url, R.drawable.gray_rectangle_bg, this)
//        else
//            com.codingpixel.connectfight.helpers.ImageLoader.load(R.drawable.gray_rectangle_bg, this)
//    }
